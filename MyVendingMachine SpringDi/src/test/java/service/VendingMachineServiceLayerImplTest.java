...
//        VendingMachineDao dao = new VendingMachineDaoFileImpl("testserviceproduct.txt");
//        VendingMachineAuditDao adao = new VendingMachineAuditDaoImpl();
//        service = new VendingMachineServiceLayerImpl(dao,adao);
